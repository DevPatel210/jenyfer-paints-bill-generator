...
// Helper function to format the InvoiceNo
const formatInvoiceNo = (invoiceNo) => {
  if (!invoiceNo) return "";
  const invoiceSplit = invoiceNo.split("-");
  return `${invoiceSplit[2]} | ${invoiceSplit[0]}-${invoiceSplit[1]}`;
};
        ...
        <div className={styles["bill-container"]}>
          ...
          <div className={styles.header}>
            <div className={styles["header-main"]}>
              ...
              <p>
                21, Comet Estate, Opp. Anant Estate, Nagervel Hanuman Road,
          ...
          <div className={styles["info-bar"]}>
            ...
            <div>
              GST NO: <strong>24BGNPP3642R1ZN</strong>
            </div>
          ...
          <div className={styles["customer-details"]}>
            ...
            <div className={styles["invoice-details"]}>
              <p>
                <strong>INVOICE NO :</strong> {formatInvoiceNo(bill.invoiceNo)}
              </p>
              <p>
                <strong>DATE :</strong> {formatDate(bill.date)}
              </p>
              <p>
                <strong>TRANSPORT NAME :</strong> {bill.transportName}
              </p>
              <p>
                <strong>VEHICLE NO :</strong> {bill.vehicleNo}
              </p>
              <p>
                <strong>L.R.NO :</strong> {bill.lrNo}
              </p>
            </div>
          </div>
          ...
          <table className={styles["products-table"]}>
            <thead>
              <tr>
                <th rowSpan="2" className={styles["sr-no"]}>
                  Sr. No.
                </th>
                <th rowSpan="2" className={styles["item-desc"]}>
                  Item Description
                </th>
                <th rowSpan="2" className={styles["hsn-code"]}>
                  HSN CODE
                </th>
                <th rowSpan="2">Qty.</th>
                <th colSpan="2"> </th>
          ...
          <div className={styles["summary-footer-container"]}>
            <div className={styles["left-panel"]}>
              <div className={styles["bank-details"]}>
                ...
                <pre style={{ marginTop: "8px", fontSize: "14px" }}>
                  {bankDetails}
                </pre>
              </div>
            </div>
              ...
              <table className={styles["totals-table"]}>
                <tbody>
                  <tr>
                    ...
                    <td
                      className={`${styles["align-right"]} ${styles["ps-col"]}`}
                    >
                      <strong>{totalAmount.ps}</strong>
                    </td>
                  </tr>
                  <tr>
                    <td>CGST 9%</td>
                  ...
                  <tr className="grand-total">
                    ...
                    <td className={styles["align-right"]}>
                      <strong>{grandTotalAmount.rs}</strong>
                    </td>
                    <td
                      className={`${styles["align-right"]} ${styles["ps-col"]}`}
                    >
                      <strong>{grandTotalAmount.ps}</strong>
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <div
            className={styles["summary-footer-container"]}
          ...
          >
            ...
            <div className={styles["right-panel"]}>
              <div className={styles.signature}>
                <p>
                  FOR, <strong>Jenyfer Paints</strong>
                </p>
